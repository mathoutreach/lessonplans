...
\begin{figure*}
   ...
   \begin{tabular}{|c|c|c|}
     ...
     \hline
     right & $r$ & \includegraphics[width=2cm]{l.pdf}\\
     \hline
     left & $\ell$ &\includegraphics[width=2cm]{r.pdf}\\
     \hline
     flip & $f$ & \includegraphics[width=2cm]{f0.pdf}\\
     \hline
     flip right & $f_r$ &\includegraphics[width=2cm]{f2.pdf}\\
     \hline
     flip left & $f_\ell$ & \includegraphics[width=2cm]{f1.pdf}\\
     \hline
   \end{tabular}
\end{figure*}
...
\begin{figure*}[h]
  \centering
   \includegraphics[width=6cm]{rf.pdf}
\end{figure*}
which is just $f_r$!  If we do this in the opposite order, doing $f$
then $r$, we get
\begin{figure*}[h]
  \centering
   \includegraphics[width=6cm]{fr.pdf}
\end{figure*}
